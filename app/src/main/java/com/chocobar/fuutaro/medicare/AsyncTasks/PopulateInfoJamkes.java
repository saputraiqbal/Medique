...
public class PopulateInfoJamkes extends AsyncTask<String, Void, String>{
   public interface ListPelayananInfo{
    ...
    public PopulateInfoJamkes(ListPelayananInfo listener){
    ...
    protected String doInBackground(String... strings) {
        ...
        List<Object> dataReceived = AsyncTaskActivity.doAsyncTask("User_getListAvailableJamkesInPartner", "intIDPartner#" + strings[0]);
            ...
            if(soapResponse.toString().equals("CallSpExcecutionResponse{}") || soapResponse == null)
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    if(i == (jArray.length() - 1))
                        info = info + jsonInfo.getString("txtJenisJamKes");
                    else
                        info = info + jsonInfo.getString("txtJenisJamKes") + ", ";
                }
            }
